...
//               <CarouselContent className="flex w-full justify-center gap-4 md:ml-40">
        ...
        <div className="flex w-full items-center justify-center">
          {reviews && (
            <Carousel
              ...
              className="ml-6 mr-0 w-full md:ml-0"
            >
              <CarouselContent className="flex w-full">
                {reviews.map((review, index) => (
                  <CarouselItem key={index} className="w-full md:basis-1/4">
                    <div className="flex h-full flex-col items-start justify-start gap-6 rounded-xl border border-[#DEDEDE] bg-transparent px-4 py-6">
              ...
              <div className="group absolute -bottom-12 left-1/2 flex w-fit -translate-x-1/2 transform items-center gap-2 pb-8">
                <CarouselPrevious className="border-[#000] text-[#000] transition group-hover:-translate-x-2" />
                <CarouselNext className="border-[#000] text-[#000] transition group-hover:translate-x-2" />
              </div>
            </Carousel>
          )}
        </div>
