  ...
  return (
    ...
    >
      <div className="flex h-full w-full max-w-[1300px] flex-col gap-[2.5rem] px-0 py-12 pl-0 md:px-2 md:py-24">
        <div className="flex w-full flex-col lg:flex-row">
          <div className="flex w-full flex-col gap-8 bg-[#F7F4ED] px-6 lg:w-1/2 lg:px-28">
            <div className="flex flex-col gap-8">
              <h1 className="font-playfair text-4xl font-medium uppercase tracking-[5px] text-[#000] md:leading-[50px] lg:text-5xl">
                Get in
                <br /> Touch
              </h1>
            </div>
            <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-4">
                  <Link href={"https://g.co/kgs/dKbaavM"} target="_blank">
                    <p className="text-[#000]">
                      14 Williamson St, Liverpool <br /> L1 1EB, United
                      Kingdom{" "}
                    </p>
                  </Link>
                  <Link href={"https://g.co/kgs/dKbaavM"} target="_blank">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex flex-col gap-4">
                  <Link href="tel:+01513453923" className="text-[#000]">
                    0151 345 3923
                  </Link>
                </div>
              </div>
              <div className="flex items-center gap-6">
                ...
                <div className="flex flex-col gap-4">
                  <Link
                    href="mailto:info@blendsbrunch.co.uk"
                    className="text-[#000]"
                  >
                    info@blendsbrunch.co.uk
                  </Link>
                </div>
              </div>
        ...
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2260.80702841147!2d-2.9844258000000004!3d53.406011!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487b2157140ef677%3A0x5fba4c238af6cfb4!2sBlends%20cafe!5e1!3m2!1sen!2sin!4v1744096896385!5m2!1sen!2sin"
          style={{ border: 0 }}
          allowFullScreen
          loading="lazy"
